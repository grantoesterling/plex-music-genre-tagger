...
def main():
    ...
    if "--help" in sys.argv or "-h" in sys.argv:
        ...
        print()
        print("Examples:")
        print("  # Dry run - analyze what would be cleaned")
        print("  python clean_plex_metadata.py")
        print()
        print("  # Test with first 10 albums only")
        print("  python clean_plex_metadata.py --limit 10")
        print()
        print("  # Actually clean metadata")
        print("  python clean_plex_metadata.py --execute")
        print()
        print("  # Clean and export removed tags report")
        print("  python clean_plex_metadata.py --execute --export-removed")
        print()
        print("  # Show current tags for clean albums")
        print("  python clean_plex_metadata.py --verbose")
        print()
        print("Recommended Workflow:")
        print("  1. python clean_plex_metadata.py  # Dry run first")
        print("  2. python clean_plex_metadata.py --execute  # Apply changes")
        print("  3. python rym_plex_updater.py --execute  # Add RYM data")
        return
